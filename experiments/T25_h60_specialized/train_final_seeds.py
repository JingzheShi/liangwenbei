"""T25: Train final 223-d Scheme C LightGBM models per seed for iter_005.
...
recipe as T11/T5b. Produces one model file per (seed, horizon) for the iter_005
ensemble Predictor.

Aggressive T25 SEED_CONFIGS (matches loso_train.py).
...
def main():
    ...
    print(f"=== T25 train_final_seeds horizons={horizons} seeds={seeds} use_gpu={args.use_gpu} ===", flush=True)
