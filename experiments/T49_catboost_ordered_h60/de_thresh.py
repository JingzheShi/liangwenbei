"""T49 DE 4D threshold search on 5-seed-averaged OOF h_60 CatBoost predictions (Ordered).

For a given tag (default 'plain'), loads
...
Schema is 1:1 the same as T37 (parquet column names match), so this is a
straight adapt of T37/de_thresh.py with different file prefix.
"""
...
def main():
    ...
    print(f"=== T49 DE thresh search tag={args.tag} seeds={seeds} ===", flush=True)
