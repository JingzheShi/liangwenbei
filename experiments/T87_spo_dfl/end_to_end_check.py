"""End-to-end check for iter_015 Predictor (T87 SPO+ DFL).

Same as T81's end_to_end_check.py but loads from iter015_pkg.
"""
...
def load_test_batches(n_files: int = 10, n_test_per_file: int = 8):
    test_files = []
...
def main():
    print("=== iter_015 end-to-end check (T87 SPO+ DFL) ===", flush=True)
