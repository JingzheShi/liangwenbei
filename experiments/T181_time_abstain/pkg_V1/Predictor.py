"""Predictor for T181 V1 conservative time-window abstain wrapper on top of T170.
...
if __name__ == "__main__":
    ...
    df_abstain = df.copy()
    df_abstain["time"] = "09:43:00"  # AM first 10 min, SHOULD abstain
    out2 = p.predict([df_abstain])
    print("abstained (9:43 AM) ->", out2[0], "(expect [1,1,1,1,1])")
    df_ood = df.copy()
    df_ood["sym"] = 99
