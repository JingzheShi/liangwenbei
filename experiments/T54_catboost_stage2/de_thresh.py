"""T54 DE 4D threshold search on 5-seed-averaged OOF h_60 CatBoost predictions.

Same structure as T46/de_thresh.py but reads cb_stage2_pred_seed{S}_held{K}.parquet
from this directory. Writes cb_stage2_thresh_results.json.
"""
...
def main():
    ...
    print(f"=== T54 DE thresh search tag={args.tag} seeds={seeds} ===", flush=True)
