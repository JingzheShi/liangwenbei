"""Predictor V1_adaptive_thr: T168 per-batch multiplicative adaptive threshold variant.

V1: batch_med_abs / GLOBAL_BASELINE_MED_ABS -> adapt_factor -> thr_up/dn /= adapt_factor
Strong signal batch → lower thresholds (more trades); weak batch → higher thresholds.
All other logic (conformal band, NN/LGB ensemble) is identical to iter_019 v2 baseline.
