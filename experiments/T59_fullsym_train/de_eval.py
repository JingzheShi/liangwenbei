...
def load_avg_pred(seeds, prefix="full_pred_h60") -> pd.DataFrame:
...
def main():
    seeds = [1, 7, 13, 42, 100]
    print(f"=== T59 DE 4D thresh search seeds={seeds} ===", flush=True)
    ...
    # Comparison vs iter_008 LOSO +16.84
    iter008_de_sum = 16.84  # noted as benchmark in task
    iter008_raw_sum = 5.77   # raw argmax 5-seed

    out = {
        "task": "T59 DE 4D thresh search on full-sym 5-seed-avg test predictions",
        "seeds": seeds,
        "n_test": len(df),
        "raw_argmax": {
        ...
        "compare_iter008": {
            ...
            "t59_de_single_total_vs_iter008_de": de_single_total - iter008_de_sum,
            "t59_de_loso_sum_vs_iter008_de": de_loso_sum - iter008_de_sum,
            "t59_raw_loso_equiv_vs_iter008_raw": float(sum(raw_per_sym)) - iter008_raw_sum,
        },
    }
    ...
    print(f"vs iter_008 +16.84: t59_de_loso_diff={de_loso_sum - iter008_de_sum:+.4f}", flush=True)
