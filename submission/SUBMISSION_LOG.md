...
| 002  | 2026-05-06 | LightGBM **Scheme C** (T2 154 last-tick + T3 72 features = 226d) **× 5 horizons 各一个独立模型** + per-horizon thresholds | multi-horizon 5 head；每个 horizon 独立训练 + 独立调 threshold | **LOSO h_10 +21.86, h_20 +19.70, h_5 +17.49, h_40 +11.71, h_60 +6.30 — 全 horizon positive!** | h_10 (best of 5) | _待提交_ | h_10 LOSO single ~+1.6e-04 | h_10 LOSO 0.55 | **🏆 当前最强**：best of 5 horizons = +21.86 (h_10)；远超 iter_001f +13.91；`submission_050606_iter002.zip` 15.19MB / 22 sanity ✓ |
