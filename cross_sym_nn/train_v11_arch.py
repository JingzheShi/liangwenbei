"""V11: train 5 v11 transformer archs on v9 features (319d = 259 + 60).

Same data + D no_aug pipeline as v9. Swaps build_model_v11 → build_model_v11.
"""
...
from models_v11 import build_model_v11, count_params
...
def train_v11(seed, device, keep_idx_npy, sel_idx_npy, zstats_npz,
             arch='v6_pairwise', out_tag='v11_features60',
        ...
        try:
            ...
            wandb.init(project=wandb_project, entity='jingzheshi', name=run_name,
                       config=dict(arch=arch, seed=seed, n_feat=n_feat,
                                   ...
                                   ablation='v11_features60', mirror_aug=False, scale_jitter=False,
    ...
    model = build_model_v11(arch, n_sym=5, n_feat=n_feat, **overrides).to(device)
...
def main():
    ...
    ap.add_argument('--arch', type=str, default='v11_minillama')
    ...
    ap.add_argument('--out-root', type=str, default='runs_v11')
    ap.add_argument('--out-tag', type=str, default='v11_arch')
    args = ap.parse_args()
