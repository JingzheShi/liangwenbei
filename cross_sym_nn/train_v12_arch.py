"""V12: train 5 v12 intra×cross interleave archs on v9 features (319d = 259 + 60).

Same data + D no_aug pipeline as v11. Uses build_model_v12.
"""
...
from models_v12 import build_model_v12, count_params
...
def train_v11(seed, device, keep_idx_npy, sel_idx_npy, zstats_npz,
             arch='v12_a_deeper', out_tag='v12_arch',
        ...
        try:
            ...
            wandb.init(project=wandb_project, entity='jingzheshi', name=run_name,
                       config=dict(arch=arch, seed=seed, n_feat=n_feat,
                                   ...
                                   ablation='v12_interleave', mirror_aug=False, scale_jitter=False,
    ...
    model = build_model_v12(arch, n_sym=5, n_feat=n_feat, **overrides).to(device)
...
def main():
    ...
    ap.add_argument('--arch', type=str, default='v12_a_deeper')
    ...
    ap.add_argument('--out-root', type=str, default='runs_v12')
    ap.add_argument('--out-tag', type=str, default='v12_arch')
    args = ap.parse_args()
